...
public class RatingDataOperator {
    ...
    public Document getAveragePostRating(String postID) {
    ...
    public void deleteAllPostsAllRatings(int[] postsList) { collection.deleteOne(eq("postsList", postsList));
    }

    public void deleteAllPostRatings(Integer postID) { collection.deleteOne(eq("postID", postID));
    }
}
